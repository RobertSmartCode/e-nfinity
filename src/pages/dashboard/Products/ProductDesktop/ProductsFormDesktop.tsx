...
const handleCategoryChange = (event: React.ChangeEvent<HTMLInputElement>) => {
  ...
  if (productSelected) {
    const updatedProductSelected = { ...productSelected, category: value };
    setProductSelected(updatedProductSelected);
  }

  // Actualizar el nuevo producto
  const updatedNewProduct = { ...newProduct, category: value };
...
const handleSubcategoryChange = (event: React.ChangeEvent<HTMLInputElement>) => {
  ...
  // Actualizar el nuevo producto
  const updatedNewProduct = { ...newProduct, subCategory: value };
  setNewProduct(updatedNewProduct);
